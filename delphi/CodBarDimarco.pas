...
interface
 ...
 uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, Biblioteca;
...
begin
     ...
     { Executa o codbar }
     Result := CreateProcess(PChar(ExePath),
                             StrFmt(Buffer, '%s %s -b %d %s', [ExePath,
                             PrnParm, FBanco, DataPath]),
